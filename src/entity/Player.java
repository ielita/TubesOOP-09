...
public class Player extends Entity{
    ...
    public Player(GamePanel gp,KeyHandler keyH){
        ...
        Item testItem7 = new equipment("Watering Can", "Untuk Keperluan Menyiram");
        Item testItem8 = new equipment("Hoe", "HOEEEE");
        ...
        inventoryManager.addItem(testItem7, 1);
        inventoryManager.addItem(testItem8, 1);
